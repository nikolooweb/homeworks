...
public class StreamsExercise {
    ...
    public static double getAverageAge(List<User> users) {
        return users.stream().map(User::getAge).mapToInt(v -> v).average().orElseThrow();
    }

    public static Integer getMaxAge(List<User> users) {
        return users.stream().map(User::getAge).mapToInt(v -> v).max().orElseThrow();
    }

    public static Integer getMinAge(List<User> users) {
        return users.stream().map(User::getAge).mapToInt(v -> v).min().orElseThrow();
    }
